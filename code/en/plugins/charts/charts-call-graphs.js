...
var lineChartH = document.querySelectorAll('#line-charth')[0]
...
// Grafica de escaneos Historicos
if (lineChartH) {
	var lineDemoChartH = new Chart(lineChartH, {
		type: 'line',
		data: {
			labels: ["Lunes", "Martes", "Miercoles", "Jueves", "Viernes", "Sabado", "Domingo"],
			datasets: [{
				data: [1, 10, 22, 30, 90, 65, 10, 25],
				label: "Depresión",
				fill:true,
				backgroundColor:blueFade,
				borderColor: blueFull,
...
// Grafica de positivos/negativos
...
if (pieChart) {
	var pieDemoChart = new Chart(pieChart, {
		type: 'pie',
		data: {
			labels: ["Depresion", "Ansiedad"],
			datasets: [{
				backgroundColor: [blueFull, greenFull],
